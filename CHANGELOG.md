...
- Importing or pasting subtitles keeps cue lines that are only a number — a year, a score, a "3 / 2 / 1" countdown — instead of silently deleting them or dropping the cue entirely (#2150)
